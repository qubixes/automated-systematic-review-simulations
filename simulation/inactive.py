...
def create_objective_func(data_fp, const_param={}):
    ...
    def objective_func(param):
        ...
        X = Doc2Vec(param=real_param).fit_transform(texts)
...
if __name__ == "__main__":
    ...
    obj_function = create_objective_func(data_fp, const_param)
    hyper_space, _ = Doc2Vec(param=const_param).hyper_space()
    trials_fp = os.path.join("trials.pkl")
