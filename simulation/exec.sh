...
# asreview simulate pickle/schoot-lgmm-ptsd_words_20000.pkl --n_prior_included 10  --n_prior_excluded 10  --n_queries 2  --n_instances 50  --config_file sim_settings.ini --log_file test/results0.log
...
asreview simulate ../data/ptsd/PTSD_VandeSchoot_18.csv --config_file svm_test.ini --log_file test/result0.json  --verbose 2 
